...
out = cv2.VideoWriter('detect.avi', fourcc, 20.0, (1760,480))
...
def draw_circle(world, eye, detect_world, detect_eye, recognize_area):
    ...
    # 画十字标
    cv2.line(world, (detect_world.world_x - 10, detect_world.world_y), (detect_world.world_x + 10, detect_world.world_y), (255, 255, 0), thickness=5)
    cv2.line(world, (detect_world.world_x, detect_world.world_y - 10), (detect_world.world_x, detect_world.world_y + 10), (255, 255, 0), thickness=5)

    cv2.putText(world,recognize_area.rec_result.iloc[-1, 0],(detect_world.world_x-50, detect_world.world_y-50),cv2.FONT_ITALIC,0.8, (100, 200, 80), 2)

    cv2.rectangle(eye, (detect_eye.pupil_x, detect_eye.pupil_y),
        (detect_eye.pupil_x+detect_eye.pupil_w, detect_eye.pupil_y+detect_eye.pupil_h), (150, 255, 0), 3)
    cv2.rectangle(eye, (detect_eye.eye_x, detect_eye.eye_y),
        (detect_eye.eye_x+detect_eye.eye_w, detect_eye.eye_y+detect_eye.eye_h), (0, 255, 0), 3)
    # 画十字标
    cv2.line(eye, (detect_eye.pupil_c_x - 30, detect_eye.pupil_c_y), (detect_eye.pupil_c_x + 30, detect_eye.pupil_c_y), (255, 255, 0), thickness=2)
    cv2.line(eye, (detect_eye.pupil_c_x, detect_eye.pupil_c_y - 30), (detect_eye.pupil_c_x, detect_eye.pupil_c_y + 30), (255, 255, 0), thickness=2)
